...
filterPanel <- wellPanel(
  ...
  selectizeInput(inputId = "journal", label="Journal", choices = NULL, multiple = TRUE, options = list(placeholder = 'Select journal(s)')),
  div(style = "margin-top:-15px"),
  selectizeInput(inputId = "study", "Type of Research", choices = NULL, multiple = TRUE, options = list(placeholder = 'Select research type(s)')),
  div(style = "margin-top:-15px"),
  selectizeInput(inputId = "bucket", "Type of Publication", choices = NULL, multiple = TRUE, options = list(placeholder = 'Select publication type(s)')),
  div(style = "margin-top:-15px"),
  selectizeInput(inputId = "author", "Author(s)", choices = NULL, multiple = TRUE, options = list(placeholder = 'Select author(s)')),
  div(style = "margin-top:-15px"),
  selectizeInput(inputId = "specialty", "Specialty", choices = NULL, multiple = TRUE, options = list(placeholder = 'Select area(s) of interest')),
  div(style = "margin-top:-15px"),
