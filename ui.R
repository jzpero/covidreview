...
filterPanel <- wellPanel(
  ...
  selectizeInput(inputId = "journal", label="Journal", choices = NULL, multiple = TRUE),
  div(style = "margin-top:-15px"),
  selectizeInput(inputId = "study", "Type of Research", choices = NULL, multiple = TRUE),
  div(style = "margin-top:-15px"),
  selectizeInput(inputId = "bucket", "Type of Publication", choices = NULL, multiple = TRUE),
  div(style = "margin-top:-15px"),
  selectizeInput(inputId = "author", "Author(s)",choices = NULL, multiple = TRUE),
  div(style = "margin-top:-15px"),
  selectizeInput(inputId = "specialty", "Specialty",choices = NULL, multiple = TRUE),
  div(style = "margin-top:-15px"),
